...
int checkMove(int  oldX, int  oldY, int  newX, int  newY, int board[8][8]){
    ...
    if(abs(futureX) == abs(futureY) && abs(board[oldY][oldX]) > 1){
        if(futureX < 0 && futureY < 0) {
            for(absFutX = abs(futureX); absFutX > 0; absFutX--){
                ...
                if (board[oldY+absFutX][oldX+absFutX] == board[oldY][oldX])
                    countOurCheck++;
            }
    ...
    else if(futureX > 0 && futureY > 0){                 //Влево вверх
    ...
    else if(futureX < 0 && futureY > 0) {           //Вправо вверх
        if(board[oldY-1][oldX+1] == 0){
            if(newX == (oldX + 1) && newY == (oldY - 1) && (board[oldY][oldX] > 0))
                return 1;
            else return 0;
    ...
    else if(futureX < 0 && futureY < 0) {           //Вправо вниз
        if(board[oldY+1][oldX+1] == 0){
            if(newX == (oldX + 1) && newY == (oldY + 1) && (board[oldY][oldX] < 0))
                return 1;
            else return 0;
